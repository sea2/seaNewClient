package com.lhy.mvp.module.photo.bigphoto;
...
import com.lhy.mvp.injector.components.DaggerBigPhotoComponent;
...
import com.lhy.mvp.utils.AnimateHelper;
import com.lhy.mvp.utils.CommonConstant;
import com.lhy.mvp.utils.DownloadUtils;
import com.lhy.mvp.utils.NavUtils;
import com.lhy.mvp.utils.OneKeyShareUtils;
import com.lhy.mvp.utils.SnackbarUtils;
import com.lhy.mvp.widget.PhotoViewPager;
    ...
    public void onClick(final View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_praise:
                ...
                break;
            case R.id.iv_share:
                new OneKeyShareUtils().share(BigPhotoActivity.this, "海洋新闻真的不错哦", "https://baidu.com",
                        mAdapter.getData(mCurPosition).getImgsrc(),  "海洋新闻真的不错哦", "123455");
                break;
        }
        // 除分享外都做动画和数据库处理
