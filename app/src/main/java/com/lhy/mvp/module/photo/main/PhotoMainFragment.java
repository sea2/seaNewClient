...
import com.lhy.mvp.injector.components.DaggerPhotoMainComponent;
...
import com.lhy.mvp.rxbus.event.LoveEvent;
...
public class PhotoMainFragment extends BaseFragment<IRxBusPresenter> implements IPhotoMainView {
    ...
    protected void initViews() {
        ...
        mPagerAdapter.setItems(fragments, new String[]{"福利", "生活", "美女"});
