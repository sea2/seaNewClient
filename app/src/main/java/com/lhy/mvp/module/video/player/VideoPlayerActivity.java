...
import com.lhy.mvp.engine.danmaku.DanmakuConverter;
import com.lhy.mvp.engine.danmaku.DanmakuLoader;
import com.lhy.mvp.engine.danmaku.DanmakuParser;
import com.lhy.mvp.injector.components.DaggerVideoPlayerComponent;
...
import com.lhy.mvp.widget.dialog.ShareBottomDialog;
...
import static com.lhy.mvp.utils.CommonConstant.VIDEO_DATA_KEY;
...
public class VideoPlayerActivity extends BaseActivity<IVideoPresenter> implements IVideoView {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            mLlEditLayout.setVisibility(View.GONE);
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            ivTopBar.setVisibility(View.VISIBLE);
            mLlEditLayout.setVisibility(View.VISIBLE);
        }
