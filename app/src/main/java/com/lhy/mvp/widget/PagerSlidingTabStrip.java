...
import com.lhy.mvp.utils.DensityUtils;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean isIndicatorLong = true;
    //滑动的线是长还是短
    private int shortIndicator = 20;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mUnderlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, ContextCompat.getColor(getContext(), R.color.transparent));
        ...
        isIndicatorLong = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsIndicatorLong, true);
        ...
        mTabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabBackground, R.color.transparent);
        ...
        shortIndicator = DensityUtils.dp2px(getContext(), 15);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw indicator line 指示线是充满还是短线
        if (mIndicatorHeight > 0) {
            mRectPaint.setColor(mIndicatorColor);
            Pair<Float, Float> lines = getIndicatorCoordinates();
            int paddingLine = 0;
            if (!isIndicatorLong) paddingLine = shortIndicator;
            canvas.drawRect(lines.first + mPaddingLeft + paddingLine, height - mIndicatorHeight, lines.second + mPaddingLeft - paddingLine, height, mRectPaint);
        }
    }
