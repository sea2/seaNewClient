...
public class BaseLivingListFragment extends BaseLivingPlayFragment implements SwipeRefreshLayout.OnRefreshListener, SuperRecyclerView.OnItemClickListenr {
    ...
    public View initView(LayoutInflater inflater, @Nullable ViewGroup container) {
        View inflate = inflater.inflate(R.layout.fragment_living_list, container, false);
